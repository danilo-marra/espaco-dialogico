/**
 * Sistema de Email para Convites (versão CommonJS para scripts)
 *
 * Este arquivo é uma versão CommonJS do emailService.js para ser usado
 * em scripts Node.js que não usam ES modules.
 */
