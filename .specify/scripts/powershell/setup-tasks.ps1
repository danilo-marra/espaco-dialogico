...
if ($Json) {
    [PSCustomObject]@{
        ...
        FINAL_VALIDATION = [PSCustomObject]@{
            TEST_COMMAND = 'npm run test'
            MIGRATION_CREATE_COMMAND = 'npm run migrations:create <nome-da-migration>'
            MIGRATION_RULE = 'exports.down = false'
        }
    ...
    Write-Output 'FINAL_VALIDATION:'
    Write-Output '  - Run tests: npm run test'
    Write-Output '  - Create migrations with: npm run migrations:create <nome-da-migration>'
    Write-Output '  - Migration policy: exports.down = false'
